...
public class CreamAdapter extends RecyclerView.Adapter<CreamAdapter.SuperViewHolder> {
    ...
    /**
     * List of View which takes in all the child and parent views of inflated adapterLayout.
     */
    private List<View> viewListWithParent;
    ...
    public class SuperViewHolder extends RecyclerView.ViewHolder {
        ...
        public SuperViewHolder(@NonNull View itemView) {
            ...
            viewListWithParent = new ArrayList<>();
            viewListWithParent.addAll(getAllChildrenWithParent(itemView));
    ...
    /**
     * Method to find and return all child and parent views present in
     * adapterLayout to finally add them in viewList.
     *
     * @param v The View is the view generated by the LayoutInflator
     *          in onBindViewHolder, through which we get all the
    ...
    public List<View> getAllChildrenWithParent(View v) {
        ...
        if (!(v instanceof ViewGroup)) {
            ArrayList<View> viewArrayList1 = new ArrayList<View>();
            viewArrayList1.add(v);
            return viewArrayList1;
        }

        ArrayList<View> result1 = new ArrayList<View>();
        ViewGroup viewGroup = (ViewGroup) v;
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            View child = viewGroup.getChildAt(i);
            result1.add(child);
            result1.addAll(getAllChildrenWithParent(child));
        }
        return result1;
    }
